...
<head>
    ...
    <!-- Title -->
<title>"{{config('Aic Ade', 'AIC ACADEMY')}}"</title>
...
<body>
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(images/bg-img/bg-1.jpg);">
                <div class="container h-100">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(images/bg-img/bg-2.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="400ms">
                        <div class="testimonial-thumb">
                            <img src="images/bg-img/t1.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="500ms">
                        <div class="testimonial-thumb">
                            <img src="images/bg-img/t2.jpg" alt="">
                        </div>
                        <div class="testimonial-content">
                ...
                <div class="col-12 col-md-6">
                    <div class="single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="600ms">
                        <div class="testimonial-thumb">
                            <img src="images/bg-img/t3.jpg" alt="">
                        </div>
                        <div class="testimonial-content">
                ...
                <div class="col-12 col-md-6">
                    <div class="single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="700ms">
                        <div class="testimonial-thumb">
                            <img src="images/bg-img/t4.jpg" alt="">
                        </div>
                        <div class="testimonial-content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="600ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url(images/bg-img/pc-3.jpg);"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="700ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url(images/bg-img/pc-4.jpg);"></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="footer-widget mb-100">
                            ...
                            <div class="gallery-list d-flex justify-content-between flex-wrap">
                                <a href="images/bg-img/gallery1.jpg" class="gallery-img" title="Gallery Image 1"><img src="img/bg-img/gallery1.jpg" alt=""></a>
                                <a href="images/bg-img/gallery2.jpg" class="gallery-img" title="Gallery Image 2"><img src="img/bg-img/gallery2.jpg" alt=""></a>
                                <a href="images/bg-img/gallery3.jpg" class="gallery-img" title="Gallery Image 3"><img src="img/bg-img/gallery3.jpg" alt=""></a>
                                <a href="images/bg-img/gallery4.jpg" class="gallery-img" title="Gallery Image 4"><img src="img/bg-img/gallery4.jpg" alt=""></a>
                                <a href="images/bg-img/gallery5.jpg" class="gallery-img" title="Gallery Image 5"><img src="img/bg-img/gallery5.jpg" alt=""></a>
                                <a href="images/bg-img/gallery6.jpg" class="gallery-img" title="Gallery Image 6"><img src="img/bg-img/gallery6.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!-- Footer Widget Area -->
